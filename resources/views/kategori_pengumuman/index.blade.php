...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-center">Kategori Pengumuman</div>
                <div class="card-body">
                    <td>
                    <a href="{!! route('kategori_pengumuman.index') !!}" class="btn btn-success">Data Yang Tersimpan</a>
